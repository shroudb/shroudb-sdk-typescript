/**
 * Internal ShroudbCourier protocol codec.
 *
 * This module is an implementation detail of the ShroudbCourier client library.
 * Do not import directly — use `ShroudbCourierClient` instead.
 *
...
export const DEFAULT_PORT = 6999;
  ...
  private parseFrame(
    ...
    switch (tag) {
      ...
      case "-": {
        ...
        if (reject) reject(ShroudbCourierError._fromServer(code, detail));
        return undefined;
      }
      case ":":
        this.buffer = after;
      ...
      case "_":
        ...
        return { value: null, rest: after };
      default:
        throw new ShroudbCourierError("INTERNAL", `Unknown response type: ${tag}`);
    }
  }
