 ...
 * Do not import directly — use `ShroudbKeepClient` instead.
 *
  ...
  private parseFrame(
    ...
    switch (tag) {
      ...
      case "-": {
        ...
        if (reject) reject(ShroudbKeepError._fromServer(code, detail));
        return undefined;
      }
      case ":":
        this.buffer = after;
      ...
      case "_":
        ...
        return { value: null, rest: after };
      default:
        throw new ShroudbKeepError("INTERNAL", `Unknown response type: ${tag}`);
    }
  }
