/**
 * Internal ShroudbTransit protocol codec.
 *
 * This module is an implementation detail of the ShroudbTransit client library.
 * Do not import directly — use `ShroudbTransitClient` instead.
 *
...
export const DEFAULT_PORT = 6499;
  ...
  private parseFrame(
    ...
    switch (tag) {
      ...
      case "-": {
        ...
        if (reject) reject(ShroudbTransitError._fromServer(code, detail));
        return undefined;
      }
      case ":":
        this.buffer = after;
      ...
      case "_":
        ...
        return { value: null, rest: after };
      default:
        throw new ShroudbTransitError("INTERNAL", `Unknown response type: ${tag}`);
    }
  }
