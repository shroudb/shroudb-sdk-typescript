/**
 * Internal ShroudbPulse protocol codec.
 *
 * This module is an implementation detail of the ShroudbPulse client library.
 * Do not import directly — use `ShroudbPulseClient` instead.
 *
...
export const DEFAULT_PORT = 7099;
  ...
  private parseFrame(
    ...
    switch (tag) {
      ...
      case "-": {
        ...
        if (reject) reject(ShroudbPulseError._fromServer(code, detail));
        return undefined;
      }
      case ":":
        this.buffer = after;
      ...
      case "_":
        ...
        return { value: null, rest: after };
      default:
        throw new ShroudbPulseError("INTERNAL", `Unknown response type: ${tag}`);
    }
  }
