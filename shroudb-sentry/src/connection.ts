/**
 * Internal ShroudbSentry protocol codec.
 *
 * This module is an implementation detail of the ShroudbSentry client library.
 * Do not import directly — use `ShroudbSentryClient` instead.
 *
...
export const DEFAULT_PORT = 6799;
  ...
  private parseFrame(
    ...
    switch (tag) {
      ...
      case "-": {
        ...
        if (reject) reject(ShroudbSentryError._fromServer(code, detail));
        return undefined;
      }
      case ":":
        this.buffer = after;
      ...
      case "_":
        ...
        return { value: null, rest: after };
      default:
        throw new ShroudbSentryError("INTERNAL", `Unknown response type: ${tag}`);
    }
  }
